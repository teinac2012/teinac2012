...
Apasionado por la programación, la creación de videojuegos y todo lo relacionado con la informática, tanto **software** como **hardware**. Me gusta entender cómo funcionan los ordenadores desde la base hasta el producto final.

🌐 **Portfolio**
- 💼 Portfolio personal (HTML): http://bit.ly/3Zir1Tp
